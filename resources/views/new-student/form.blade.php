...
@section('main-content')
    <div class="container">
        ...
        <form
            action="{{ $new_student->exists ? Route('new-students.update', $new_student->id) : Route('new-students.store') }}"
            method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="gender-1" value="Laki-Laki"
                                @if ($new_student->gender == 'Laki-Laki') checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="gender-2" value="perempuan"
                                @if ($new_student->gender == 'perempuan') checked @endif>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="hobby[]" id="hobby-1"
                                value="Olahraga" @if (in_array('Olahraga', $hobbies)) checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="hobby[]" id="hobby-2"
                                value="tari" @if (in_array('tari', $hobbies)) checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="hobby[]" id="hobby-3"
                                value="Musik" @if (in_array('Musik', $hobbies)) checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="hobby[]" id="hobby-5"
                                value="Membaca" @if (in_array('Membaca', $hobbies)) checked @endif>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="hobby-6"
                                onchange="document.getElementById('hobbyLainnya').toggleAttribute('disabled')">
                            <input class="form-control" type="text" name="hobby[]" id="hobbyLainnya" value=""
                                disabled>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="province">
                        @foreach (['Kalimantan Timur', 'Kalimantan Utara', 'Kalimantan Selatan', 'Kalimantan Barat', 'Kalimantan Tengah'] as $prov)
                            <option @if ($prov == $new_student->prov) selected @endif>{{ $prov }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select name="lastEdu" class="form-control">
                        @foreach (['SMA - IPA', 'SMA - IPS', 'SMA - Bahasa', 'SMK'] as $last_edu)
                            <option @if ($last_edu == $new_student->last_edu)  @endif>{{ $last_edu }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <?php
            $departments = App\Models\Department::with('study_programs')->get();
            ?>

            <div class="row">
                <div class="col-md-4">
                    <label for="">Program Studi 1</label>
                    <select name="prodi1_id" class="form-control">
                            ...
                            <optgroup label="{{ $department->name }}">
                                ...
                                @foreach ($department->study_programs as $study_program)
                                    <option value="{{$study_program->id}}"
										@if ($study_program->id == $new_student->study_program_1_id)
											selected
										@endif
									>
                                        {{ $study_program->name }}
                ...
                <div class="col-md-4">
                    ...
                    <select name="prodi2_id" class="form-control">
						<option value="" selected disabled></option>
                        ...
                        @foreach ($departments as $department)
                            <optgroup label="{{ $department->name }}">
                                ...
                                @foreach ($department->study_programs as $study_program)
                                    <option value="{{$study_program->id}}"
										@if ($study_program->id == $new_student->study_program_2_id) selected
										@endif
									>
                                        {{ $study_program->name }}
                                    </option>
